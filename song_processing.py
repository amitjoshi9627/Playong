...
def more_than_1_song_play(browser, num_songs=2):
    ...
    while(song_number <= num_songs):
        try:
            ...
            time.sleep(1)
            track_name = browser.find_element_by_xpath(
                '/html/body/article/div/div[3]/section/div[3]/div/strong/a').text
            album_name = browser.find_element_by_xpath(
                '/html/body/article/div/div[3]/section/div[3]/div/span/a').text
...
def play_user_timed_songs(browser, song_time=20, num_songs=25):
    browser.find_elements_by_xpath(
        '/html/body/div[8]/div/section/div/div[2]/div[2]/div/div/button')[0].click()
    time.sleep(1)
    track_name = browser.find_element_by_xpath(
        '/html/body/article/div/div[3]/section/div[3]/div/strong/a').text
    album_name = browser.find_element_by_xpath(
